...
2.  **Important:** If you have other content in your `custom` directory, confirm none contain a `valve.rc` file to ensure full functionality. If any exist, you should either delete them or merge their contents into your `autoexec.cfg` file.
