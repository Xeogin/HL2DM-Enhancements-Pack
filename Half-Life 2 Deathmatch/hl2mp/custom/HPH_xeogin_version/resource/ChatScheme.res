Scheme
{
	...
	Colors
	{
		...
		Color_Btn                   "26 26 26 50" // custom for this scheme, see source in SourceScheme.res
		Color_BtnFocused            "22 22 22 50" // custom for this scheme, see source in SourceScheme.res
		Color_BtnPressed            "18 18 18 50" // custom for this scheme, see source in SourceScheme.res

		Color_Slider                "26 26 26 50" // custom for this scheme, see source in SourceScheme.res
		Color_SliderTrack           "0 0 0 50" // custom for this scheme, see source in SourceScheme.res

		Color_ActionElemBg          "50 32 16 50" // custom for this scheme, see source in SourceScheme.res
